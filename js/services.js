...
// First Toggle dropdown div
function toggleFunction1() {
    let toggle = document.getElementById("drop_content1");
...
// Second Toggle dropdown div
function toggleFunction2() {
    let toggle = document.getElementById("drop_content2");
    if (toggle.style.display === "block") {
        toggle.style.display = "none";
    }
    else{
...
// Third Toggle dropdown div
function toggleFunction3() {
    let toggle = document.getElementById("drop_content3");
    if (toggle.style.display === "block") {
        toggle.style.display = "none";
    }
    else{
